...
export default function Footer({ quote, attribution }: FooterProps) {
  ...
  const { url: bannerUrl, artwork: bannerArtwork } = useSolarpunkBackgroundWithMeta('footer-banner');
        ...
        <div className={styles.container}>
          ...
          <div className={styles.bottomRow}>
            ...
            <div className={styles.socialLinks}>
              ...
              <a href="https://linkedin.com/in/evie-marie-kolb" target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
                <svg fill="currentColor" viewBox="0 0 24 24">
